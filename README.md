...
* [GoogleGenAI.jl](https://github.com/tylerjthomas9/GoogleGenAI.jl) ⭐ 18 | 🐛 2 | 🌐 Julia | 📅 2026-08-18 - Unofficial wrapper for the Google Gemini API.
...
* [HumanEval.jl](https://github.com/01-ai/HumanEval.jl) ⭐ 25 | 🐛 1 | 🌐 Julia | 📅 2024-08-17 - The Julia version of [openai/human-eval](https://github.com/openai/human-eval) ⭐ 3,345 | 🐛 44 | 🌐 Python | 📅 2025-01-17. It rewrites the original Python problems into the Julia version and provides evaluation results with several latest LLMs.
