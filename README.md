...
* [Llama2.jl](https://github.com/cafaxo/Llama2.jl) ⭐ 141 | 🐛 12 | 🌐 Julia | 📅 2024-08-15 - Llama2.jl provides simple code for inference and training of llama2-based language models based on [llama2.c](https://github.com/karpathy/llama2.c) ⭐ 20,056 | 🐛 190 | 🌐 C | 📅 2024-08-06. It supports loading quantized weights in GGUF format (`q4_K_S` variant). Other similar projects: [LanguageModels.jl](https://github.com/rai-llc/LanguageModels.jl) ⭐ 65 | 🐛 9 | 🌐 Julia | 📅 2023-10-08
...
| PostgreSQL + [pgvector](https://github.com/pgvector/pgvector?tab=readme-ov-file#hnsw) ⭐ 22,928 \| 🐛 14 \| 🌐 C \| 📅 2026-08-20 |              [LibPQ.jl](https://github.com/iamed2/LibPQ.jl) ⭐ 227 \| 🐛 62 \| 🌐 Julia \| 📅 2026-09-06             |                       [pgvector examples for Julia](https://github.com/pgvector/pgvector-julia) ⭐ 8 \| 🐛 0 \| 🌐 Julia \| 📅 2026-07-09                       |
...
* [llama\_cpp\_jll.jl](https://juliahub.com/ui/Packages/General/llama_cpp_jll/) - JLL package for [llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 127,272 | 🐛 2,445 | 🌐 C++ | 📅 2026-09-06, the best interface for quantized llama2-style models.
...
* [HumanEval.jl](https://github.com/01-ai/HumanEval.jl) ⭐ 25 | 🐛 1 | 🌐 Julia | 📅 2024-08-17 - The Julia version of [openai/human-eval](https://github.com/openai/human-eval) ⭐ 3,367 | 🐛 45 | 🌐 Python | 📅 2025-01-17. It rewrites the original Python problems into the Julia version and provides evaluation results with several latest LLMs.
...
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 180,297 | 🐛 3,915 | 🌐 Go | 📅 2026-09-05 - The best option for those looking to host a Large Language Model locally. Simply start the server and send the requests with [HTTP.jl](https://github.com/JuliaWeb/HTTP.jl) ⭐ 688 | 🐛 6 | 🌐 Julia | 📅 2026-08-31.
...
* [LangChain](https://github.com/langchain-ai/langchain) ⭐ 145,807 | 🐛 450 | 🌐 Python | 📅 2026-09-06 - The best option for building applications on top of LLMs (eg, Chains, Agents). It has a lot of adapters for common models, databases, and other services.
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,252 | 🐛 1 | 🌐 Rust | 📅 2026-09-06 - Let LLMs run code on your computer (eg, Python, JavaScript, Shell, and more). An open-source local alternative to OpenAI Code Interpreter.
* [Llama Index](https://github.com/run-llama/llama_index) ⭐ 52,040 | 🐛 715 | 🌐 Python | 📅 2026-09-05 - Similar to LangChain but with a focus on data-centered applications like RAG.
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,832 | 🐛 39 | 🌐 Python | 📅 2026-09-05 - Simple yet powerful structured extraction framework on top of OpenAI API. Excellent to understand the power of function calling API together with Pydantic.
...
* [Awesome Generative AI](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,567 | 🐛 634 | 📅 2026-09-06 - Great list for all things generative AI. An inspiration for this list!
