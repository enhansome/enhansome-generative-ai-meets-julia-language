...
| PostgreSQL + [pgvector](https://github.com/pgvector/pgvector?tab=readme-ov-file#hnsw) ⭐ 22,777 \| 🐛 14 \| 🌐 C \| 📅 2026-08-20 |              [LibPQ.jl](https://github.com/iamed2/LibPQ.jl) ⭐ 227 \| 🐛 62 \| 🌐 Julia \| 📅 2026-08-26             |                       [pgvector examples for Julia](https://github.com/pgvector/pgvector-julia) ⭐ 8 \| 🐛 0 \| 🌐 Julia \| 📅 2026-07-09                       |
...
* [llama\_cpp\_jll.jl](https://juliahub.com/ui/Packages/General/llama_cpp_jll/) - JLL package for [llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 125,885 | 🐛 2,225 | 🌐 C++ | 📅 2026-08-27, the best interface for quantized llama2-style models.
...
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 179,543 | 🐛 3,801 | 🌐 Go | 📅 2026-08-27 - The best option for those looking to host a Large Language Model locally. Simply start the server and send the requests with [HTTP.jl](https://github.com/JuliaWeb/HTTP.jl) ⭐ 687 | 🐛 6 | 🌐 Julia | 📅 2026-08-22.
...
* [Stipple.jl](https://github.com/GenieFramework/Stipple.jl) ⭐ 356 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-27 - For building interactive data applications in pure Julia (part of Genie.jl ecosystem). Excellent for building web-based interfaces for GenAI applications.
...
* [LangChain](https://github.com/langchain-ai/langchain) ⭐ 145,113 | 🐛 433 | 🌐 Python | 📅 2026-08-27 - The best option for building applications on top of LLMs (eg, Chains, Agents). It has a lot of adapters for common models, databases, and other services.
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,162 | 🐛 7 | 🌐 Rust | 📅 2026-08-20 - Let LLMs run code on your computer (eg, Python, JavaScript, Shell, and more). An open-source local alternative to OpenAI Code Interpreter.
* [Llama Index](https://github.com/run-llama/llama_index) ⭐ 51,891 | 🐛 666 | 🌐 Python | 📅 2026-08-27 - Similar to LangChain but with a focus on data-centered applications like RAG.
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,786 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - Simple yet powerful structured extraction framework on top of OpenAI API. Excellent to understand the power of function calling API together with Pydantic.
* [Marvin](https://github.com/prefecthq/marvin) ⭐ 6,192 | 🐛 113 | 🌐 Python | 📅 2026-08-21 - Powerful building blocks to quickly build AI applications and expose them via a production-ready API.
...
* [Awesome Generative AI](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,537 | 🐛 607 | 📅 2026-08-03 - Great list for all things generative AI. An inspiration for this list!
