...
* [Flux.jl](https://github.com/FluxML/Flux.jl) ⭐ 4,746 | 🐛 46 | 🌐 Julia | 📅 2026-09-14 - Flux is a machine learning library for Julia that is flexible and allows building complex models. However, at the time of writing, I'm not aware of any Large Language Models (LLMs) that have been implemented and trained in Flux.
...
* [Llama2.jl](https://github.com/cafaxo/Llama2.jl) ⭐ 141 | 🐛 12 | 🌐 Julia | 📅 2024-08-15 - Llama2.jl provides simple code for inference and training of llama2-based language models based on [llama2.c](https://github.com/karpathy/llama2.c) ⭐ 20,089 | 🐛 190 | 🌐 C | 📅 2024-08-06. It supports loading quantized weights in GGUF format (`q4_K_S` variant). Other similar projects: [LanguageModels.jl](https://github.com/rai-llc/LanguageModels.jl) ⭐ 65 | 🐛 9 | 🌐 Julia | 📅 2023-10-08
...
* [Whisper.jl](https://github.com/aviks/Whisper.jl) ⭐ 52 | 🐛 2 | 🌐 Julia | 📅 2026-08-23 - Julia interface to whisper.cpp, a high-performance inference in C/C++ of OpenAI's Whisper automatic speech recognition (ASR) model.
...
* [OpenAI.jl](https://github.com/JuliaML/OpenAI.jl) ⭐ 119 | 🐛 7 | 🌐 Julia | 📅 2026-06-06 - A community-maintained Julia wrapper to the OpenAI API.
...
| PostgreSQL + [pgvector](https://github.com/pgvector/pgvector?tab=readme-ov-file#hnsw) ⭐ 23,045 \| 🐛 16 \| 🌐 C \| 📅 2026-09-10 |              [LibPQ.jl](https://github.com/iamed2/LibPQ.jl) ⭐ 227 \| 🐛 62 \| 🌐 Julia \| 📅 2026-09-17             |                       [pgvector examples for Julia](https://github.com/pgvector/pgvector-julia) ⭐ 8 \| 🐛 0 \| 🌐 Julia \| 📅 2026-07-09                       |

## Packages

* [PromptingTools.jl](https://github.com/svilupp/PromptingTools.jl) ⭐ 173 | 🐛 36 | 🌐 Julia | 📅 2026-07-03 - Helps with everyday applications of Large Language Models in Julia by wrapping coming APIs, re-using prompts via templates, and enabling easy transition between different model providers (eg, OpenAI, Ollama). (Disclaimer: I'm the author of this package.)
...
* [LLMTextAnalysis.jl](https://github.com/svilupp/LLMTextAnalysis.jl) ⭐ 42 | 🐛 4 | 🌐 Julia | 📅 2025-02-01 - Leverage Large Language Models to uncover, evaluate, and label themes/concepts/spectra in large document collections. (Disclaimer: I'm the author of this package.)
* [RAGTools.jl](https://github.com/JuliaGenAI/RAGTools.jl) ⭐ 34 | 🐛 5 | 🌐 Julia | 📅 2025-11-27 - Build and use Retrieval-Augmented Generation (RAG) systems. A module carved out of PromptingTools.jl.
...
* [llama\_cpp\_jll.jl](https://juliahub.com/ui/Packages/General/llama_cpp_jll/) - JLL package for [llama.cpp](https://github.com/ggerganov/llama.cpp) ⭐ 128,588 | 🐛 2,490 | 🌐 C++ | 📅 2026-09-17, the best interface for quantized llama2-style models.
...
* [HumanEval.jl](https://github.com/01-ai/HumanEval.jl) ⭐ 25 | 🐛 1 | 🌐 Julia | 📅 2024-08-17 - The Julia version of [openai/human-eval](https://github.com/openai/human-eval) ⭐ 3,382 | 🐛 45 | 🌐 Python | 📅 2025-01-17. It rewrites the original Python problems into the Julia version and provides evaluation results with several latest LLMs.
...
* [Genie UI Assistant](https://forem.julialang.org/pgimenez/introducing-genie-ui-assistant-the-ai-powered-ui-builder-for-genie-apps-3jpe) - Genie UI Assistant is a GPT-4 powered
  UI builder helping [Genie.jl's](https://github.com/GenieFramework/Genie.jl) ⭐ 2,413 | 🐛 126 | 🌐 Julia | 📅 2026-09-04 users create UIs faster using natural language.
...
* [FlashRank.jl](https://github.com/svilupp/FlashRank.jl) ⭐ 8 | 🐛 2 | 🌐 Julia | 📅 2024-11-18 - Fast and local document ranking with models that can run on any computer (CPU-based). Based on Python's [FlashRank](https://github.com/PrithivirajDamodaran/FlashRank) ⭐ 1,006 | 🐛 10 | 🌐 Python | 📅 2026-07-11.
...
* [Ollama](https://github.com/jmorganca/ollama) ⭐ 181,163 | 🐛 4,030 | 🌐 Go | 📅 2026-09-17 - The best option for those looking to host a Large Language Model locally. Simply start the server and send the requests with [HTTP.jl](https://github.com/JuliaWeb/HTTP.jl) ⭐ 688 | 🐛 0 | 🌐 Julia | 📅 2026-09-17.
...
* [Stipple.jl](https://github.com/GenieFramework/Stipple.jl) ⭐ 356 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-29 - For building interactive data applications in pure Julia (part of Genie.jl ecosystem). Excellent for building web-based interfaces for GenAI applications.
...
Python is on the leading edge of the generative AI revolution. Fortunately, we have [PythonCall.jl](https://github.com/JuliaPy/PythonCall.jl) ⭐ 1,075 | 🐛 209 | 🌐 Julia | 📅 2026-09-16 allowing us to easily call all the below Python packages.

* [LangChain](https://github.com/langchain-ai/langchain) ⭐ 146,540 | 🐛 537 | 🌐 Python | 📅 2026-09-17 - The best option for building applications on top of LLMs (eg, Chains, Agents). It has a lot of adapters for common models, databases, and other services.
* [Open Interpreter](https://github.com/KillianLucas/open-interpreter) ⭐ 68,367 | 🐛 3 | 🌐 Rust | 📅 2026-09-15 - Let LLMs run code on your computer (eg, Python, JavaScript, Shell, and more). An open-source local alternative to OpenAI Code Interpreter.
* [Llama Index](https://github.com/run-llama/llama_index) ⭐ 52,203 | 🐛 803 | 🌐 Python | 📅 2026-09-17 - Similar to LangChain but with a focus on data-centered applications like RAG.
* [Instructor](https://github.com/jxnl/instructor) ⭐ 13,913 | 🐛 64 | 🌐 Python | 📅 2026-09-16 - Simple yet powerful structured extraction framework on top of OpenAI API. Excellent to understand the power of function calling API together with Pydantic.
* [Marvin](https://github.com/prefecthq/marvin) ⭐ 6,198 | 🐛 114 | 🌐 Python | 📅 2026-09-11 - Powerful building blocks to quickly build AI applications and expose them via a production-ready API.
...
* [Awesome Generative AI](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,648 | 🐛 680 | 📅 2026-09-16 - Great list for all things generative AI. An inspiration for this list!
